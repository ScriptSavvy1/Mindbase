...
export default function SignUpPage() {
  ...
  const [role, setRole] = useState<"learner" | "pending_instructor">("learner");
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    router.push(role === "learner" ? "/dashboard" : "/instructor");
  };
      ...
      <div className="w-full max-w-md space-y-8 animate-fade-in">
        ...
        <div className="text-center">
          ...
          <p className="mt-2 text-text-secondary">
            Start learning AI & Fintech today
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          >
            ...
            <span className="text-sm font-medium">I want to learn</span>
          </button>
          <button
            onClick={() => setRole("pending_instructor")}
            className={`flex flex-col items-center gap-2 p-4 rounded-lg border transition-all cursor-pointer ${
          ...
          >
            ...
            <span className="text-sm font-medium">I want to teach</span>
          </button>
        </div>
